...
RUN apt-get update && apt-get install -yq git nano cron supervisor php5-mcrypt openssl postgresql php5-pgsql php5-curl php5-gd php5-intl php5-ldap && rm -rf /var/lib/apt/lists/*
